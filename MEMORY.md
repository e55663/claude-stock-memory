...
- [✅追蹤報表請款項目補齊:7月已100%完成](project_tracking_item_backfill_0721.md) — 7/21七月43列全補完+格式一致化(合計列/千分位/框線/項次重編)回測全PASS;剩45列全是6月的先等;🔴兩爭議未解(金鈺昌#4差11,000、齊昇136金額欄0但合約追加919,916);教訓=寫Excel前用廠商名驗列號、同檔可能有別session在改
