...
- [0724收尾:14件已歸檔+三項待裁示](project_billing_batch_state_0724.md) — 朋洋#8可送(112張簽單逐張核完/002076結案)、台泥#2會辦更新收件已同步、祥欣兩分頁已合併(#2 memo遺失留空)、正揚#1卡行通表查無+估價單無費率明細(另廠商少請5,000);🔴待裁示=正揚三家比價/銘亮#10重複列/4夾無查核記錄;行通表已18本16,262筆
