...
metadata: 
  ...
  modified: 2026-07-30T08:25:45.378Z
---
...
🔴**檔案位置已變(2026/07/30查證)**:`數字清單.xlsx` 與 `信用卡PPT-2022.pptx` 都已搬到 **`Downloads\個人\`**，且**最新版是「數字清單 3.xlsx」(2026/7/2)**，不是 `數字清單.xlsx`(2026/7/1)。新版把「2026情境最佳卡」分頁換成「總覽儀表板」＋「到期提醒」兩頁（儀表板列各卡結帳日與本月待填金額，到期提醒抓合約/保險到期日）。找卡片資料一律開「數字清單 3.xlsx」分頁「信用卡」。
